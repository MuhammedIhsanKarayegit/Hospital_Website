...
namespace KocamanHastanesi.Controllers
{
    public class ilController : Controller
    {
        ...
        public ilController(KocamanHastanesiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.il != null ? 
                          ...
                          Problem("Entity set 'KocamanHastanesiContext.il'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            if (_context.il == null)
            {
                return Problem("Entity set 'KocamanHastanesiContext.il'  is null.");
            }
            var il = await _context.il.FindAsync(id);
            if (il != null)
            {
