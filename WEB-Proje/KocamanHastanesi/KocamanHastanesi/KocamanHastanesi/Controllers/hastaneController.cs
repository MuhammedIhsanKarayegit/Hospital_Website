...
namespace KocamanHastanesi.Controllers
{
    public class hastaneController : Controller
    {
        ...
        public hastaneController(KocamanHastanesiContext context)
        {
            _context = context;
        }
        ...
        {
            var kocamanHastanesiContext = _context.hastane.Include(h => h.ilce);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'KocamanHastanesiContext.hastane'  is null.");
            }
            var hastane = await _context.hastane.FindAsync(id);
            if (hastane != null)
            {
